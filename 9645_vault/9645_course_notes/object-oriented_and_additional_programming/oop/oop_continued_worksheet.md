...
class Motorbike(Vehicle):
	def __init__(self, make: str, model: str, year: int, engine_displacement: float):
		super().__init__(make, model, year)
		self.__engine_displacement = engine_displacement

	def get_engine_displacement(self) -> float:
		return self.__engine_displacement

	def set_engine_displacement(self, engine_displacement: float):
		self.__engine_displacement = engine_displacement
...
class Car(Vehicle):
	...
	def set_num_doors(self, num_doors: int):
		self.__num_doors = num_doors
````
